...
module.exports = {
  ...
  run: async (message, args, text, client) => {
    ...
    if (args[0].toLowerCase() == "default") {
      sql
        .prepare(
          "INSERT OR REPLACE INTO channel (guild, channel) VALUES (?, ?);"
        )
      ...
      if (
        ...
        return message.reply(
          `I don't have permission to send message in or view ${channel}!`
        );
      } else
        sql
          .prepare(
